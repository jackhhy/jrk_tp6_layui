...
return [
    ...
    // 异常页面的模板文件
   // 'exception_tmpl'   => Env::get('app_debug') == true ? app()->getThinkPath() . 'tpl/think_exception.tpl' : app()->getBasePath() . 'common' . DIRECTORY_SEPARATOR . 'tpl' . DIRECTORY_SEPARATOR . 'think_exception.tpl',
