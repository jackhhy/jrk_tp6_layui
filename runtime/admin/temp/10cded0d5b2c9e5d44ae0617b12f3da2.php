<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\config\sysconfig\index.html";i:1596112861;s:59:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\public\base.html";i:1596107433;s:59:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\public\head.html";i:1596107433;}*/ ?>
                ...
                <div class="layui-form-item layui-form-pane">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="name" class="layui-input"  value="" type="text" placeholder="请输入配置名">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select class="layui-select" name="group_id">
...
<script type="text/html" id="operationTpl">
    <a href="javascript:;" class="layui-btn layui-btn-normal layui-btn-xs <?php echo node('Sysconfig/update'); ?>"  data-title="编辑" lay-event="edit"><i class="layui-icon"></i></a>
    <a href="javascript:;" class="layui-btn layui-btn-danger layui-btn-xs <?php echo node('Sysconfig/del'); ?>"  data-title="删除" lay-event="del"><i class="layui-icon "></i></a>
</script>

<script type="text/html" id="toolbarDemo">
    <button class="layui-btn layui-btn-sm <?php echo node('Sysconfig/addConfig'); ?>" lay-event="add"><i class="layui-icon"></i>新增</button>
    <button class="layui-btn layui-btn-sm layui-btn-primary" lay-event="reload"><i class="fa fa-refresh"></i> 刷新</button>
    <button class="layui-btn layui-btn-sm <?php echo node('Sysconfig/del'); ?> layui-btn-danger" lay-event="del"><i class="layui-icon layui-icon-delete"></i>批量删除</button>
    ...
    layui.use(['element', 'table', 'form', 'jquery', 'lucky','laydate','okTab'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'name', minWidth: 100, title: '分类名称',templet: function (d) {
                       return d.sysconfigtab.title;
                    }},
                {field: 'group', width: 120, title: '分类英文名'},
                {field: 'name', width: 250, title: '配置名'},
                {field: 'value', width: 250, title: '配置值'},
        ...
        table.on('toolbar(tableFilter)', function(obj) {
            ...
            if(obj.event==="add"){
                lucky.CreateOpenForm("添加配置",'55%','73%',"<?php echo url('addConfig'); ?>",obj.config.id);
                return false;
                ...
                lucky.FormatData(id,"<?php echo url('del'); ?>",obj.config.id,"确认删除选择的配置吗？");
            }
        });
