<?php /*a:3:{s:63:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\auth_rule\index.html";i:1596107433;s:59:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\public\base.html";i:1596107433;s:59:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\public\head.html";i:1596107433;}*/ ?>
      ...
      var treeTable = tableTree.render({
        ...
        tableTree.on('tool(tableEvent)',function (obj) {
            ...
            if(event === 'url'){
                var updates = {};
                updates[field] = value;
                lucky.Change_status("<?php echo url('common/changeStatus'); ?>","table_id","auth_rule",obj.data.id,obj.field,obj.value);
                obj.update(updates);
               // console.log(obj)
            }
            if (event==="sorts"){
            ...
            if (event==="sort"){
                if (obj.data.type==1 && obj.data._no==1){
                    ...
                    lucky.CreateOpenForm("添加节点",'55%','73%',urls,"table_id");
            ...
            if(event === 'del'){
                //console.log(obj);
                obj.del();
                lucky.FormatData(obj.data.id,"<?php echo url('del'); ?>","table_id","确认删除吗？");
               // console.log(obj);
            }
            //添加子菜单
        ...
        table.on('toolbar(tableEvent)', function(obj){
            var id = $(this).attr("id");
            if(id==="btn1"){
                lucky.CreateOpenForm("添加菜单",'55%','73%',"<?php echo url('addAuth'); ?>",obj.config.id);
                return false;
            }else if(id === 'btn2') {
                ...
                if (data.length < 1){
                    ...
                    lucky.FormatData(_id,"<?php echo url('del_all'); ?>","table_id","确认删除选中的菜单吗？");
                    return false;
                }
