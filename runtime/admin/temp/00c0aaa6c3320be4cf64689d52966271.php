<?php /*a:2:{s:73:"D:\phpstudy_pro\WWW\jrk_tp6_layui\app\admin\view\auth_rule\auth_rule.html";i:1597387661;s:67:"D:\phpstudy_pro\WWW\jrk_tp6_layui\app\admin\view\public\window.html";i:1597630457;}*/ ?>
...
<script>
    layui.use(['element', 'form', 'jquery','iconHhysFa','lucky'], function () {
        ...
        form.on('submit(add)', function (data) {
            lucky.FormSubmit("<?php echo url('addAuth'); ?>",data.field,true);
            return false;
        });
    })
</script>
