<?php /*a:2:{s:71:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\config\sysconfig\update.html";i:1596112757;s:61:"D:\phpstudy_pro\WWW\jrk_tp6\app\admin\view\public\window.html";i:1596107433;}*/ ?>
        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block input-custom-width" style="">
                        <input type="text" name="value" value="" placeholder="请输入配置值" lay-verify="" lay-vertype="tips" lay-reqtext="请输入配置值" autocomplete="off" class="layui-input ">
                    </div>
                </div>
...
<script>
    layui.use(['element', 'form', 'jquery','lucky','upload','laydate'], function () {
        ...
        form.on('submit(add)', function (data) {
            lucky.FormSubmit("<?php echo url('update'); ?>",data.field,"table_id",1);
            return false;
        });
    })
</script>
