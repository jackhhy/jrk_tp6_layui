layui.define(["laydate","laytpl","table","layer","tableEdit","form"],function(exports) {
    ...
    TableTree.prototype = {
        ...
        ,addIcon:function(tr,td,lvl) {
            ...
            var add = $('<i class="layui-icon layui-icon-add-1 layui-tableEdit-edit" onmouseover="tool.tis(this)" data-title="添加"></i>');_div.append(add);
            var update = $('<i class="layui-icon layui-icon-edit layui-tableEdit-edit" onmouseover="tool.tis(this)" data-title="编辑"></i>');_div.append(update)
            var remove = $('<i class="layui-icon layui-icon-delete layui-tableEdit-edit" onmouseover="tool.tis(this)" data-title="删除"></i>');_div.append(remove);
            var sort = $('<i class="layui-icon layui-icon-radio layui-tableEdit-edit" onmouseover="tool.tis(this)" data-title="添加节点" style="font-size: 16px"></i>');_div.append(sort);
        ...
        ,events:function () {
            ...
            tableBody.on('click','i.layui-tableEdit-edit',function (e) {
                ...
                var isAdd = $(this).hasClass('layui-icon-add-1')
                    ...
                    ,isSort = $(this).hasClass('layui-icon-radio');
             ...
             /*      var oldValue = that.parseTempletData(data,field);
                ...
                //删除
                if(isDelete){
                   // layer.confirm("确认删除吗？",{skin: 'layui-layer-molv', icon: 3, title: "提示", anim: "2"}, function(index){
                ...
                if(isSort){
                   /* var icon = $(this);
                    ...
                    var thisObj = {value:null,data:data,field:field,sort:function (newTree) {
